...
export const metadata = {
  title: "Магазин Terea и Iluma в Москве | TereaIqos",
  description:
  ...
  alternates: {
    canonical: `https://tereaiqos.ru/contacts`,
  },
  openGraph: {
    title: `Магазин Terea и Iluma в Москве | TereaIqos`,
    ...
    url: `https://tereaiqos.ru/contacts`,
    images: [
      {
  ...
  return (
    <div className="contacts">
      ...
      <div className="social">
        ...
        <p>
          Telegram: <Link href="https://t.me/Ilumastore2025">@TereaIqos</Link>
        </p>
        <p>
          Whatsapp:{" "}
