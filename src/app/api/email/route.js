...
export async function POST(req) {
  try {
    ...
    let subject = "Заявка с сайта tereaiqos.ru";
    ...
    if (text.includes('НОВЫЙ КЛИЕНТ') || text.includes('🔥 НОВЫЙ КЛИЕНТ 🔥')) {
      subject = `🔥 НОВЫЙ КЛИЕНТ: ${customerName} - tereaiqos.ru`;
    } else {
      subject = `Заявка от ${customerName} - tereaiqos.ru`;
    }
        ...
        <body>
          <div class="email-container">
            <div class="email-header">
              <h2>Заявка с сайта tereaiqos.ru</h2>
            </div>
            ...
            <div class="email-content">
              ...
              <div class="footer">
                <p>Отправлено с сайта tereaiqos.ru</p>
    ...
    const mailOptions = {
      ...
      headers: {
        ...
        'X-Mailer': 'tereaiqos.ru Contact Form'
      }
    };
