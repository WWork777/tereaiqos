...
export async function generateMetadata() {
  const title = "Купить стики Heets в TereaIqos с доставкой по Москве";
  return {
    title,
    description:
      "Каталог стиков Heets с доставкой по Москве. Лучший выбор вкусов и брендов!",
    alternates: {
      canonical: `https://tereaiqos.ru/products/heets`,
    },
    openGraph: {
      title: `Купить стики Heets в TereaIqos с доставкой по Москве`,
      description: `Каталог стиков Heets с доставкой по Москве. Лучший выбор вкусов и брендов!`,
      url: `https://tereaiqos.ru/products/heets`,
      images: [
        {
