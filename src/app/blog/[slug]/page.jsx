...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://tereaiqos.ru/blog/${article.slug}`,
    },
    openGraph: {
      title: article.title,
      description: article.metaDescription || article.description,
      url: `https://tereaiqos.ru/blog/${article.slug}`,
      type: "article",
...
export default function ArticlePage({ params }) {
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Главная",
        item: "https://tereaiqos.ru",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Блог",
        item: "https://tereaiqos.ru/blog",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: article.title,
        item: `https://tereaiqos.ru/blog/${article.slug}`,
      },
    ],
  };
  ...
  const articleSchema = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://tereaiqos.ru/logo.png",
      },
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://tereaiqos.ru/blog/${article.slug}`,
    },
  };
